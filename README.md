...
<marquee style="background: linear-gradient(90deg, #FF2D20, #61DAFB, #0EA5E9, #10B981); color: white; font-weight: bold; padding: 14px; border-radius: 10px; margin: 20px 0; font-size: 18px;">
🚀 Laravel • React • TypeScript • Flutter • Building Professional Business Solutions
</marquee>
...
I am an IT student at the **University of Heng Samrin Thbung Khmum (UHST)**. I am a dedicated developer focused on building robust business and management solutions.

**Core Stack:** Laravel, React, TypeScript, Flutter, and SQL.  
**Focus Areas:** Enterprise Management Systems (POS & Accounting), UI/UX Design, and Network Administration.  
...
![AntDesign](https://img.shields.io/badge/Ant%20Design-%230170FE.svg?style=for-the-badge&logo=ant-design&logoColor=white)
